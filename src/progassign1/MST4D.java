...
/**
 * The MST class represents a minimum spanning tree in four dimensions.
 * @author Anders Peterson
 */
public class MST4D {
    private ArrayList<Vertex4D> mst;
    private Vertex4D bestNode;
    
    public MST4D(Vertex4D first){
        mst = new ArrayList<Vertex4D>();
        mst.add(first);
        bestNode = first;
    }
     ...
     */
    public void addNode(Vertex4D v){
        for(Vertex4D node : mst){
